...
function createPagination(totalPages, currentPage, listNumberRef) {
    listNumberRef.innerHTML = '';
    if (totalPages <= 5) {
        for(let i = 1; i <= totalPages; i++)listNumberRef.insertAdjacentHTML('beforeend', `<li class="cards__elem">
        <button class="cards__number ${currentPage === i - 1 ? 'active' : ''}" type="button">${i}</button>
      </li>`);
        return;
    }
    if (currentPage < 4) {
        for(let i = 1; i <= 5; i++)listNumberRef.insertAdjacentHTML('beforeend', `<li class="cards__elem">
        <button class="cards__number ${currentPage === i - 1 ? 'active' : ''}" type="button">${i}</button>
      </li>`);
        listNumberRef.insertAdjacentHTML('beforeend', `<li class="cards__elem">
      ...
      <span class="cards__dots">....</span>
        ...
        for(let i = totalPages - 4; i <= totalPages; i++)listNumberRef.insertAdjacentHTML('beforeend', `<li class="cards__elem">
        <button class="cards__number ${currentPage === i - 1 ? 'active' : ''}" type="button">${i}</button>
      </li>`);
    } else {
        listNumberRef.insertAdjacentHTML('beforeend', `<li class="cards__elem">
      ...
      <span class="cards__dots">....</span>
        ...
        for(let i = currentPage; i <= currentPage + 2; i++)listNumberRef.insertAdjacentHTML('beforeend', `<li class="cards__elem">
        <button class="cards__number ${currentPage === i - 1 ? 'active' : ''}" type="button">${i}</button>
      </li>`);
        listNumberRef.insertAdjacentHTML('beforeend', `<li class="cards__elem">
      <span class="cards__dots">....</span>
...
},{}],"gCsL4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
